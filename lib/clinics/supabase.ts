...
function googlePlacesClinicToRow(clinic: Clinic) {
  const row: Record<string, unknown> = {
    ...
    contact_email: clinic.contactEmail || clinic.email || null,
    email_source: clinic.emailSource || null,
    email_status: clinic.emailStatus || "unknown",
    email_last_checked_at: clinic.emailLastCheckedAt || null,
    email_lookup_url: clinic.emailLookupUrl || null,
